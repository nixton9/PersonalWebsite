...
languages: ['HTML']
img: 'https://res.cloudinary.com/duejrcpct/image/upload/q_auto/v1586692868/tips/23-1_cfkcur.png'
description: 'Creating progress bars and meter bars only with some HTML'
number: 23
status: true
---

![alt text](https://res.cloudinary.com/duejrcpct/image/upload/q_auto/v1586692935/tips/23-2_ojdmtd.png "Progress and meter bars")
