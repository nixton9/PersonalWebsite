...
languages: ['HTML', 'CSS']
img: 'https://res.cloudinary.com/duejrcpct/image/upload/v1586882642/tips/49-1_os6n2l.png'
description: 'Using CSS to shorten text and add ellipsis after it'
number: 49
status: true
---

![alt text](https://res.cloudinary.com/duejrcpct/image/upload/v1586882641/tips/49-2_s9yv4w.png "Shortening text with CSS")
